...
<body class="containerQuienes" id="containerQuienes">
    ...
    <br>
    <div class="quienes">
        <h1>Qué es la Criolipólisis y para qué sirve?</h1>
        Criolipolisis es un tratamiento dermatológico no invasivo, cuyo objetivo es destruir las células grasas (adipositos) bajando su temperatura para que se descompongan y sean eliminadas, sin dañar el resto de las células de la piel.
            La temperaturas utilizadas son por debajo los cero grados.
    </div>
    <div class="quienes">
...
<h2>¿Cómo funciona la Criolipólisis?</h2>
 ...
 <div class="parrafoTres">
        <h2>¿Para quién está indicado el tratamiento?</h2>
        No está indicado para personas obesas, sino para personas que tienen grasa localizada, ya que la grasa que se elimina se hace en pequeñas cantidades y en un periodo de tiempo relativamente largo. Este tratamiento es ideal para personas que les cuesta mucho bajar una zona específica, en el que la grasa localizada no se va, a pesar del deporte y la dieta. Puede aplicarse en el abdomen, cadera, rodillas y muslos.</p>
    </div>
</body>
